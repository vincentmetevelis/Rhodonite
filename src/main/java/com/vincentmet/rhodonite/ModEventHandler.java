...
public class ModEventHandler {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        event.getRegistry().registerAll(
                ...
                Objects.Items.Armor.itemArmorRhodoniteHelmet = new BaseArmorItem(ArmorMaterials.RHODONITE, EquipmentSlotType.HEAD, new Item.Properties().stacksTo(1).tab(BaseClass.tab), (stack, level, tooltip, tooltipFlag) -> RhodoniteHelper.addRhodoniteHoverText(tooltip), (stack, level, player) -> RhodoniteHelper.doRhodoniteArmorTickLogic(player)).setRegistryName(new ResourceLocation(Ref.MODID, "item_armor_rhodonite_helmet")),
                Objects.Items.Armor.itemArmorRhodoniteChest = new BaseArmorItem(ArmorMaterials.RHODONITE, EquipmentSlotType.CHEST, new Item.Properties().stacksTo(1).tab(BaseClass.tab), (stack, level, tooltip, tooltipFlag) -> RhodoniteHelper.addRhodoniteHoverText(tooltip), (stack, level, player) -> RhodoniteHelper.doRhodoniteArmorTickLogic(player)).setRegistryName(new ResourceLocation(Ref.MODID, "item_armor_rhodonite_chestplate")),
                Objects.Items.Armor.itemArmorRhodoniteLeggins = new BaseArmorItem(ArmorMaterials.RHODONITE, EquipmentSlotType.LEGS, new Item.Properties().stacksTo(1).tab(BaseClass.tab), (stack, level, tooltip, tooltipFlag) -> RhodoniteHelper.addRhodoniteHoverText(tooltip), (stack, level, player) -> RhodoniteHelper.doRhodoniteArmorTickLogic(player)).setRegistryName(new ResourceLocation(Ref.MODID, "item_armor_rhodonite_leggings")),
                Objects.Items.Armor.itemArmorRhodoniteBoots = new BaseArmorItem(ArmorMaterials.RHODONITE, EquipmentSlotType.FEET, new Item.Properties().stacksTo(1).tab(BaseClass.tab), (stack, level, tooltip, tooltipFlag) -> {
                ...
                Objects.Items.Armor.itemArmorFluoriteHelmet = new ArmorItem(ArmorMaterials.FLUORITE, EquipmentSlotType.HEAD, new Item.Properties().stacksTo(1).tab(BaseClass.tab)).setRegistryName(new ResourceLocation(Ref.MODID, "item_armor_fluorite_helmet")),
                Objects.Items.Armor.itemArmorFluoriteChest = new ArmorItem(ArmorMaterials.FLUORITE, EquipmentSlotType.CHEST, new Item.Properties().stacksTo(1).tab(BaseClass.tab)).setRegistryName(new ResourceLocation(Ref.MODID, "item_armor_fluorite_chestplate")),
                Objects.Items.Armor.itemArmorFluoriteLeggings = new ArmorItem(ArmorMaterials.FLUORITE, EquipmentSlotType.LEGS, new Item.Properties().stacksTo(1).tab(BaseClass.tab)).setRegistryName(new ResourceLocation(Ref.MODID, "item_armor_fluorite_leggings")),
                Objects.Items.Armor.itemArmorFluoriteBoots = new BaseArmorItem(ArmorMaterials.FLUORITE, EquipmentSlotType.FEET, new Item.Properties().stacksTo(1).tab(BaseClass.tab), (stack, level, tooltip, tooltipFlag) -> RhodoniteHelper.addNoFallDamageHoverText(tooltip), (stack, level, player) -> RhodoniteHelper.setFallDamageToZero(player)).setRegistryName(new ResourceLocation(Ref.MODID, "item_armor_fluorite_boots")),
