...
public class EventHandler {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        event.getRegistry().registerAll(
                ...
                Objects.Items.Armor.itemArmorRhodoniteLeggings = new RhodoniteLeggings(ArmorMaterials.RHODONITE, EquipmentSlot.LEGS, new Item.Properties().stacksTo(1).tab(BaseClass.tab)).setRegistryName(new ResourceLocation(Ref.MODID, "item_armor_rhodonite_leggings")),
